// Inline SVG icons — avoids react-icons bundle bloat
...
export function IconBars3({ className = 'w-6 h-6' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function IconXMark({ className = 'w-6 h-6' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
    </svg>
...
export function IconBrain({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V21M16.5 3v1.5m0 15V21m-4.5-18v1.5m0 15V21m4.5-10.5h.008v.008H16.5V10.5zm0 3h.008v.008H16.5V13.5zm-3-3h.008v.008H13.5V10.5zm0 3h.008v.008H13.5V13.5zm-3-3h.008v.008H10.5V10.5zm0 3h.008v.008H10.5V13.5z" />
    </svg>
  );
}
